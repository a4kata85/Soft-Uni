...
namespace P04._PasswordValidator
{
    class StartUp
    {
        static void Main()
        {
            ...
            bool isBetween6And10 = CheckLenghtOfThePass(password);
            ...
            if (isBetween6And10 && containsOnlyDigitsAndLetters && containsMin2Digits)
            {
        ...
        private static bool CheckLenghtOfThePass(string password)
        {
